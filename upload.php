    ...
    if($error === 0){
        ...
        if(in_array($img_ex_lc,$allowed_exs)){
            ...
            move_uploaded_file($tmp_name,$img_upload_path);
                ...
                $bookingprice=mysqli_real_escape_string($con,$_POST['bookingprice']);
                $available="Y";
                $query="INSERT INTO cars(CAR_NAME,FUEL_TYPE,CAPACITY,PRICE,BOOKING_PRICE,CAR_IMG,AVAILABLE) values('$carname','$ftype',$capacity,$price,$bookingprice,'$new_img_name','$available')";
