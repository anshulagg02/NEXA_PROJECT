...
require_once('connection.php');
    if(isset($_POST['login']))
    {
        ...
        if(empty($email)|| empty($pass))
        {
            ...
            $query="select *from TEST_DRIVE where EMAIL='$email'";
...
?>
    <div class="hai">
        <div class="navbar">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="cardetails.php">EBOOK</a></li>
        ...
        <div class="content">
            <h1>Buy Your <br><span>Dream Car</span></h1>
            <p class="par">Live the life of Luxury.<br>
                Just buy a car of your wish from our vast collection.<br>Enjoy every moment with your family<br>
                 Join us to make this family vast.  </p>
            <button class="cn"><a href="register.php">Book A Test Drive</a></button>
            <!-- <div class="form">
                <h2>Login Here</h2>
                <form method="POST"> 
