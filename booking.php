...
<?php 
    ...
    if(isset($_POST['book'])){
        ...
        $uemail=mysqli_real_escape_string($con,$_POST['em']);
        ...
        if(empty($bplace)|| empty($bdate)|| empty($dur)|| empty($phno)|| empty($nam)|| empty($rdate)){
            ...
            if($bdate<$rdate){
            $price=(10000);
            $sql="insert into booking (CAR_ID,EMAIL,BOOK_PLACE,BOOK_DATE,AGE,PHONE_NUMBER,BOOKING_PERSON,PRICE,DELIVERY_DATE) values($carid,'$uemail','$bplace','$bdate',$dur,$phno,'$nam',$price,'$rdate')";
    ...
    ?>
       ...
       <div class="hai">
        ...
        <form id="register" method="POST"  >
            ...
            id="dfield"  min='1899-01-01' placeholder="Enter The delivery Date">
            <br><br>
