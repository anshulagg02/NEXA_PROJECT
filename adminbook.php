        ...
        <div class="navbar">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="adminusers.php">TEST DRIVES</a></li>
        ...
        <div>
            ...
            <div>
                ...
                <tr  class="active-row">
                    ...
                    <td><?php echo $res['BOOKING_PERSON'];?></php></td>
                    ...
                    <!-- <td><button type="submit" class="but" name="approve"><a href="adminreturn.php?id=<?php echo $res['CAR_ID']?>&bookid=<?php echo $res['BOOK_ID']?>">BOOKED SUCCESSFULLY</a></button></td> -->
                </tr>
               <?php } ?>
                </tbody>
                </table>
